...
<file path="scripts/run-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="src/arch/riscv64/boot.S">
.section .text.boot
.global _start
.type _start, @function
...
<file path="src/arch/riscv64/timer.rs">
use crate::drivers::mmio;
use crate::platform;
...
<file path="src/drivers/mod.rs">
pub mod mmio;
pub mod uart;
</file>

<file path="src/drivers/uart.rs">
use crate::drivers::mmio;
use crate::platform;
...
<file path="src/kernel/task/context.rs">
use crate::drivers::uart;
...
<file path="src/kernel/task/cpu_context.rs">
use crate::drivers::uart;
...
<file path="src/platform/mod.rs">
mod qemu_virt_riscv64;

pub use qemu_virt_riscv64::*;
</file>

<file path="src/platform/qemu_virt_riscv64.rs">
pub const UART0_BASE: usize = 0x1000_0000;
...
<file path=".codex/system_prompt.txt">
Ты — ведущий разработчик этого проекта.
Стек: Rust, Risc-V Assembler.
Правила для всех чатов в этом проекте:
1) Читать в коде только то, что нужно. Старайся минимизировать чтение ненужного для задачи кода.
...
<file path="scripts/test-kernel-fault-guard-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-scheduler-fault-lifecycle-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-scheduler-reentry-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-scheduler-run-once-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-scheduler-run-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-scheduler-runtime-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-task-resume-selftest.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="scripts/test-two-task-handoff-riscv.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="src/arch/riscv64/cpu.rs">
use core::arch::asm;
...
<file path="src/arch/riscv64/trap.S">
.section .text.trap
.align 8
.global trap_vector
...
<file path="src/kernel/task/test/bootstrap.rs">
#[cfg(feature = "scheduler_fault_lifecycle_test")]
use crate::drivers::uart;
#[cfg(feature = "two_task_resume_handoff_test")]
use crate::drivers::uart;
...
<file path="src/kernel/task/test/invariants.rs">
use crate::drivers::uart;
...
<file path="src/kernel/task/fault.rs">
use crate::drivers::uart;
...
<file path="src/kernel/memory.rs">
use crate::drivers::uart;
use crate::platform;
...
<file path="src/kernel/trap_frame.rs">
#[repr(C)]
pub struct Riscv64TrapFrame {
    pub sp: u64,
...
<file path="src/arch/riscv64/mod.rs">
use core::arch::asm;
...
<file path="src/kernel/task/mod.rs">
pub mod context;
pub mod cpu_context;
pub mod debug;
pub mod entry;
...
<file path="src/kernel/task/debug.rs">
use crate::drivers::uart;
...
<file path="scripts/check-all.sh">
#!/usr/bin/env bash
set -euo pipefail
...
<file path="src/arch/riscv64/traps.rs">
use crate::arch;
use crate::arch::riscv64::cpu;
use crate::arch::riscv64::timer;
use crate::drivers::uart;
...
<file path="src/kernel/task/entry.rs">
use crate::drivers::uart;
...
<file path="src/kernel/task/table.rs">
use crate::drivers::uart;
use crate::kernel::memory;
...
<file path="src/kernel/task/scheduler.rs">
use crate::drivers::uart;
#[cfg(feature = "scheduler_dispatch_test")]
...
<file path="src/kernel/banner.rs">
use crate::drivers::uart;
...
<file path="src/kernel/task/test.rs">
use crate::drivers::uart;
mod bootstrap;
mod invariants;
#[allow(unused_imports)]
